...
class WPPPOB_Frontend {
    ...
    public function enqueue_frontend_assets() {
        global $post;
        if (is_a($post, 'WP_Post') && (has_shortcode($post->post_content, 'wppob_form') || has_shortcode($post->post_content, 'wppob_app_view') || has_shortcode($post->post_content, 'wppob_user_dashboard'))) {
